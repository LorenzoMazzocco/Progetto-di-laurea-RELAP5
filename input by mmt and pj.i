...
*
*LA VELOCITà NEL VOLUME 200 DIVENTA NEGATIVA => IL FLUSSO TORNA INDIETRO NELLA PIPE
*LA PRESSIONE NELLA BRANCH CALA SOTTO I 155 BAR
*LA VELOCITà DELLA JUNCTION 330 è >0
*
*Titlecard
=pwr_channel
*
...
*
*crdno   Endtime[s] Mindt[s]  Maxdt[s]   ctrl  Minedit  Majedit   Rst
203        100.      1e-8      0.05     00003   20        20       1
*
204     160.0     1e-8   0.05   00003   10    10    1 
...
*
*crdno      Name      Type
3300000   val_eccs    valve
*
*crdno       From        To      Junarea[m^2]
3300101    300010000  900010003    8.79e-5    * l'area è da guardare bene
*
*crdno     Area[m^2]    Loss K fwd    Loss K bwd
3300102       0.             0.           0   * perdite che potremmo aggiungere
*
*------------------------ VALVE IC DATA ---------------------
*
*crdno    Controlword    W2   W3   W4
3300201       1          0.   0.   0.    *  (0 = velocity ; 1 = mass flow rate)
*
*crdno      TypeValve
3300300      chkvlv     
*
*crdno    TypeOfCheckValve     InitialPosition
3300301         0                    1          * flow-controlled valve, closed
*
*crdno    DeltaPressureInOrderToClose         LeakRatio
3300302              0.                           0.
*
*----------------------------------------------------------------------
*
